...
namespace Agrosis.Clases { 
    ...
    public class Cajon
    {
        ...
        public void CortaTicket()
        {
            ...
            linea.AppendLine("\x1B" + "\x70" + "0" + "10" + "40");
            linea.AppendLine("\x1D" + "\x28" + "\x41" + "2" + "0" + "0" + "2");
            // linea.AppendLine("\x1B" + "\x69"); //Avanza 9 renglones, Tambien varian
        ...
        public void ImprimirTicket()
        {
            ...
            RawPrinterHelper.SendStringToPrinter(impre.ImpresoraPred(), linea.ToString()); //Imprime texto.
